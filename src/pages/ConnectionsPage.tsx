...
const PLUGINS: Plugin[] = [
  ...
  { id: "github", name: "GitHub", category: "Developer Tools", description: "Review PRs, check issues, and manage repos", safetyLabel: "Advanced", type: "cloud", setupMethod: "oauth", icon: FileText, capabilities: "Read repos, review PRs, comment on issues", access: "Read and optional write access to repositories", microcopy: "Start with read-only access and expand as needed." },
